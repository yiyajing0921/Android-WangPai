...
public class DeviceUuidManager {
    ...
    private static final String TAG = "DeviceUuidManager";
    ...
    private static DeviceUuidManager deviceUuidFactory;
    public static DeviceUuidManager getInstance(Context context){
        if (deviceUuidFactory == null){
            deviceUuidFactory = new DeviceUuidManager(context);
        }
