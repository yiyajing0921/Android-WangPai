...
import com.woaiwangpai.iwb.wechat.share.callback.SocialCallback;
...
import com.woaiwangpai.iwb.wechat.share.entities.QQInfoEntity;
import com.woaiwangpai.iwb.wechat.share.entities.QQLoginResultEntity;
import com.woaiwangpai.iwb.wechat.share.entities.QQUnionIdEntity;
...
//                SocialUtil.getQQSex(qqInfo.getGender()), qqInfo.getFigureurl_qq_2(), qqInfo);
        return ThirdInfoEntity.createQQThirdInfo(accessToken, unionIdInfo.getUnionid(), tencent.getOpenId(), qqInfo.getNickname(), SocialUtil.getQQSex(qqInfo.getGender()), qqInfo.getFigureurl_qq_2(), qqInfo);
    }
