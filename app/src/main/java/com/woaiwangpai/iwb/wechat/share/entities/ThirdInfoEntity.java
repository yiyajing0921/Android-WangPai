package com.woaiwangpai.iwb.wechat.share.entities;


import com.woaiwangpai.iwb.wechat.share.auth.AuthResult;
...
public final class ThirdInfoEntity {
    ...
    /**
     * 平台信息：{@link #PLATFORM_WX}、{@link #PLATFORM_WX}、{@link #PLATFORM_WX}、{@link #PLATFORM_ALI}
     */
    ...
    //add
    public static ThirdInfoEntity createQQThirdInfo(String accessToken,String unionId, String openId, String nickname, String sex, String avatar, QQInfoEntity qqInfo) {
        ThirdInfoEntity thirdInfoEntity = new ThirdInfoEntity(unionId, openId, nickname, sex, avatar);
        thirdInfoEntity.setPlatform(PLATFORM_QQ);
        thirdInfoEntity.setQqInfo(qqInfo);
        thirdInfoEntity.getQqInfo().getLoginResultEntity().setAccess_token(accessToken);//add
        return thirdInfoEntity;
    }
    ...
    public static ThirdInfoEntity createAliThirdInfo(String unionId, String openId, String nickname, String sex, String avatar, AuthResult aLiInfo) {
        ThirdInfoEntity thirdInfoEntity = new ThirdInfoEntity(unionId, openId, nickname, sex, avatar);
        thirdInfoEntity.setPlatform(PLATFORM_ALI);
        thirdInfoEntity.setAliInfo(aLiInfo);
        return thirdInfoEntity;
    }
    ...
    public void setAliInfo(AuthResult aliInfo) {
        this.aliInfo = aliInfo;
    }

    public AuthResult getAliInfo() {
        return aliInfo;
    }
}
