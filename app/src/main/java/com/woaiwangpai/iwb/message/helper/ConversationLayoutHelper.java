...
import com.woaiwangpai.iwb.message.NewConversationLayout;
import com.woaiwangpai.iwb.message.NewConversationListLayout;

public class ConversationLayoutHelper {

    public static void customizeConversation(final NewConversationLayout layout) {

        NewConversationListLayout listLayout = (NewConversationListLayout) layout.getConversationList();
