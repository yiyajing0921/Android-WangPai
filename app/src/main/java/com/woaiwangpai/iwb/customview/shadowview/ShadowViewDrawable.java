package com.woaiwangpai.iwb.customview.shadowview;
...
/*使用
        ShadowProperty shadowProperty = new ShadowProperty()
                .setShadowColor(ContextCompat.getColor(this,R.color.bg_5))
                .setShadowDx(ScreenManager.dp2px(this, 2))
                .setShadowDy(ScreenManager.dp2px(this, 2))
                .setShadowRadius(ScreenManager.dp2px(this, 8))
        ...
        ViewCompat.setBackground(llTag, shadowViewDrawable);
        ViewCompat.setLayerType(llTag, View.LAYER_TYPE_SOFTWARE, null);
 */
/*
//        ShadowProperty shadowProperty = new ShadowProperty()
//                .setShadowColor(ContextCompat.getColor(this,R.color.bg_5))
//                .setShadowDx(ScreenManager.dp2px(this, 2))
//                .setShadowDy(ScreenManager.dp2px(this, 2))
//                .setShadowRadius(ScreenManager.dp2px(this, 10))
//                .setShadowSide(ShadowProperty.TOP | ShadowProperty.LEFT | ShadowProperty.RIGHT | ShadowProperty.BOTTOM);
//        ShadowViewDrawable shadowViewDrawable = new ShadowViewDrawable(shadowProperty, Color.WHITE, 0, 0);
//        ViewCompat.setBackground(llTag, shadowViewDrawable);
//        ViewCompat.setLayerType(llTag, View.LAYER_TYPE_SOFTWARE, null);
...
//        this.addContentView(loadView, layoutParams);
 */
