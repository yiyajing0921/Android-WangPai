...
public class UserIconView extends RelativeLayout {
    ...
    public void invokeInformation(boolean isGroup) {
        //是否群组
        if (isGroup) {
            mIconView.setImageResource(R.drawable.conversation_group);
        } else {
            mIconView.setImageResource(R.drawable.ic_no_heard);
        }
    }
